...
const PLAN_DEFS = {
  free: {
    ...
    limits: { aiGenerationsPerMonth: 10, maxPresentations: 3, imageGenerationsPerMonth: 5 },
    features: { exportPdf: false, exportHtml: true, customBranding: false, liveAudience: false, narrativeAnalysis: false, imageStudio: false },
  },
  pro: {
    id: 'pro',
    name: 'Pro',
    ...
    limits: { aiGenerationsPerMonth: 150, maxPresentations: 100, imageGenerationsPerMonth: 100 },
    features: { exportPdf: true, exportHtml: true, customBranding: true, liveAudience: true, narrativeAnalysis: true, imageStudio: true },
  },
  business: {
    id: 'business',
    name: 'Business',
    ...
    limits: { aiGenerationsPerMonth: 600, maxPresentations: -1, imageGenerationsPerMonth: 500 },
    features: { exportPdf: true, exportHtml: true, customBranding: true, liveAudience: true, narrativeAnalysis: true, imageStudio: true },
  },
};
