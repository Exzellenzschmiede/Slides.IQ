...
const PLAN_DEFS = {
  free: {
    ...
    limits: { aiGenerationsPerMonth: 10, maxPresentations: 3, imageGenerationsPerMonth: 5, audioGenerationsPerMonth: 0, campaignGenerationsPerMonth: 0 },
    features: { exportPdf: false, exportHtml: true, customBranding: false, liveAudience: false, narrativeAnalysis: false, imageStudio: false, storyStudio: true, audioStudio: false, campaignStudio: false },
  },
  pro: {
    id: 'pro',
    name: 'Pro',
    ...
    limits: { aiGenerationsPerMonth: 150, maxPresentations: 100, imageGenerationsPerMonth: 100, audioGenerationsPerMonth: 50, campaignGenerationsPerMonth: 20 },
    features: { exportPdf: true, exportHtml: true, customBranding: true, liveAudience: true, narrativeAnalysis: true, imageStudio: true, storyStudio: true, audioStudio: true, campaignStudio: true },
  },
  business: {
    id: 'business',
    name: 'Business',
    ...
    limits: { aiGenerationsPerMonth: 600, maxPresentations: -1, imageGenerationsPerMonth: 500, audioGenerationsPerMonth: 200, campaignGenerationsPerMonth: 100 },
    features: { exportPdf: true, exportHtml: true, customBranding: true, liveAudience: true, narrativeAnalysis: true, imageStudio: true, storyStudio: true, audioStudio: true, campaignStudio: true },
  },
};
