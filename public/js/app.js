...
import { makeLibrary } from './views/library.js';
import { renderStoryStudio } from './views/storyStudio.js';
import { makeAudioStudio } from './views/audioStudio.js';
import { renderCampaignStudio } from './views/campaignStudio.js';
...
registerView('stories', makeLibrary('story'));
registerView('story-studio', renderStoryStudio);
registerView('voices', makeLibrary('voice'));
registerView('voice-studio', makeAudioStudio('voice'));
registerView('sounds', makeLibrary('music'));
registerView('music-studio', makeAudioStudio('music'));
registerView('campaigns', makeLibrary('campaign'));
registerView('campaign-studio', renderCampaignStudio);
